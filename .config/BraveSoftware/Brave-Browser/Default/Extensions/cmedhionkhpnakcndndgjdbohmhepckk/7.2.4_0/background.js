...
var getIsStartup = function () { return isStartup; };
    ...
    return runtime_info_generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                ...
                _c.label = 5;
            case 5:
                if (!runtimeInfo.isAppVersionChanged) return [3, 7];
...
var updateSettingsFromServer = function () { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    var response, networkRules, cssRules, popupConfig, scripletsRules, updatePageConfig, data;
    var _a;
...
var tryOpenUpdatePage = function (updatePageConfig) { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    ...
    return update_settings_from_server_generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                shouldCheckUpdatePageConfig = _a.sent();
                ...
                return [4, setToChromeStorage(ExtensionsKeys.ShouldCheckUpdatePageConfig, false)];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                if (!shouldShowForCurrentVersion) {
                    return [2];
                }
            ...
            case 5:
                e_1 = _a.sent();
                console.error('open update page failed:', e_1);
                return [3, 6];
            case 6: return [2];
        }
    });
