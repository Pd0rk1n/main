...
complete -c nvme-connect-all -s J -l config -d 'Use the specified JSON configuration file instead of the default /etc/nvme/co…'
...
complete -c nvme-connect-all -l concat -d 'Enable secure concatenation (TCP)'
...
complete -c nvme-connect-all -s o -l output-format -d 'Set the reporting format to normal, json or binary'
complete -c nvme-connect-all -s v -l verbose -d 'Increase the information detail in the output'
