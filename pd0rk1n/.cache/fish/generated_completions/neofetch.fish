...
complete -c neofetch -l ip_interface -d 'Interface(s) to use for local IP'
...
complete -c neofetch -l memory_unit -d 'Memory output unit'
...
complete -c neofetch -l catimg -d 'Shortcut to use \'catimg\' backend'
...
complete -c neofetch -l pot -d 'Shortcut to use \'pot\' backend'
...
complete -c neofetch -l ueberzug -d 'Shortcut to use \'ueberzug\' backend'
complete -c neofetch -l viu -d 'Shortcut to use \'viu\' backend'
...
complete -c neofetch -l catimg_size -d 'Change the resolution of catimg'
