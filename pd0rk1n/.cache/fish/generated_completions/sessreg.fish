...
complete -c sessreg -s V -l version -d 'This option causes the command to print its version and exit'
complete -c sessreg -s a -d 'This session should be added to utmpx/wtmpx'
complete -c sessreg -s d -d 'This session should be deleted from utmpx/wtmpx.  One of'
