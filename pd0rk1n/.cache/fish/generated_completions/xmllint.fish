...
complete -c xmllint -l c14n -l c14n11 -l exc-c14n -d 'Use the W3C XML Canonicalisation (C14N) to serialize the result of parsing to…'
...
complete -c xmllint -l huge -d 'Ignore some hardcoded parser limits'
...
complete -c xmllint -l nocompact -d 'Do not generate compact text nodes (parser option XML_PARSE_COMPACT)'
complete -c xmllint -l nodefdtd -d 'Do not set default HTML doctype (parser option HTML_PARSE_NODEFDTD)'
complete -c xmllint -l nodict -d 'Don\\*(Aqt use dictionaries (parser option XML_PARSE_NODICT)'
complete -c xmllint -l noenc -d 'Ignore encoding declaration (parser option XML_PARSE_IGNORE_ENC)'
complete -c xmllint -l noent -d 'Substitute entity values for entity references'
complete -c xmllint -l nofixup-base-uris -d 'Don\\*(Aqt fix xml:base URIs when processing XIncludes (parser option XML_PARS…'
...
complete -c xmllint -l oldxml10 -d 'Use deprecated parsing rules before XML 1. 0, 5th edition'
...
complete -c xmllint -l pretty -d 'Value 0 means no formatting, 1 means XML_SAVE_FORMAT (same as --format), 2 me…'
...
complete -c xmllint -l sax -d 'Print SAX callbacks (only for debugging)'
complete -c xmllint -l sax1 -d 'Use deprecated SAX1 interface (only for debugging)'
complete -c xmllint -l schema -d 'Use a W3C XML Schema file named SCHEMA for validation'
complete -c xmllint -l schematron -d 'Use a Schematron file named SCHEMA for validation'
