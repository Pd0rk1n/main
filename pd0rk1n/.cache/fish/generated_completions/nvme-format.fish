...
complete -c nvme-format -s t -l timeout -d 'Override default timeout value 600,000.  In milliseconds'
complete -c nvme-format -s o -l output-format -d 'Set the reporting format to normal, json or binary'
complete -c nvme-format -s v -l verbose -d 'Increase the information detail in the output'
