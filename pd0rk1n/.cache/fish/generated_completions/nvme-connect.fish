...
complete -c nvme-connect -l keyring -d 'Keyring for TLS key lookup, either the key id or the keyring name'
complete -c nvme-connect -l tls-key -d 'TLS key for the connection (TCP), either the TLS key in interchange format or…'
complete -c nvme-connect -l tls-key-identity -d 'The identity used for the tls-key'
