...
complete -c mksquashfs -o help -d 'print help summary information to stdout'
...
complete -c mksquashfs -o ha -d 'shorthand alternative to -help-all. SS "Miscellaneous options:"'
