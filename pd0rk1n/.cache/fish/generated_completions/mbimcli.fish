...
complete -c mbimcli -l help-compal -d 'Show Compal Service options . SS "Basic Connect options:"'
...
complete -c mbimcli -l compal-query-at-command -d 'send AT command to modem, and receive AT response . SS "Application Options:"'
