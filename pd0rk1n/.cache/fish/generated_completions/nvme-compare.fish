...
complete -c nvme-compare -s o -l output-format -d 'Set the reporting format to normal, json or binary'
complete -c nvme-compare -s v -l verbose -d 'Increase the information detail in the output'
complete -c nvme-compare -l timeout -d 'Override default timeout value.  In milliseconds'
